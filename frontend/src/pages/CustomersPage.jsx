        ...
        <div className={styles.detailPanel}>
          {!selected ? (
            <div className={styles.noSelection}>
              <div className={styles.noSelIcon}>👥</div>
            ...
            <div className={styles.detail} key={selected._id}>
              ...
              <div className={styles.detailStats}>
                ...
                <div className={styles.dStat}>
                  <div className={styles.dStatVal}>${(selectedDetail.totalSpent || 0).toFixed(2)}</div>
                  <div className={styles.dStatLbl}>Total Spent</div>
                </div>
                <div className={styles.dStat}>
                  <div className={styles.dStatVal}>{new Date(selectedDetail.createdAt).toLocaleDateString()}</div>
                    ...
                    {selectedDetail.orders.map(o => (
                      <div key={o._id} className={styles.orderItem}>
                        <div>
                          ...
                          <div className={styles.orderDate}>{new Date(o.createdAt).toLocaleDateString()}</div>
                        </div>
                        ...
                        <div className={styles.orderTotal}>${o.totalAmount?.toFixed(2)}</div>
                      </div>
                    ))}
                  </div>
                </div>
