    ...
    <div className={styles.page}>
      ...
      {loading ? (
        <div className={styles.loadingArea}>
          {[...Array(5)].map((_, i) => <div key={i} className={`skeleton ${styles.skRow}`} />)}
        </div>
      ) : (
            ...
            return (
              <div key={order._id} className={styles.tableGroup}>
                <div className={styles.tableRow}>
                  ...
                  <span>
                    <button className={styles.delBtn} onClick={() => setDeleteId(order._id)}>🗑️</button>
                  </span>
                </div>
                {expanded === order._id && (
                  <div className={styles.itemsList}>
                    ...
                    {order.deliveryAddress && (
                      <div className={styles.deliveryAddr}>📍 {order.deliveryAddress}</div>
                    )}
                  </div>
                )}
              </div>
